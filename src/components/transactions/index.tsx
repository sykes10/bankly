...
export const TransactionHistory = () => {
  const { data: transactions, isLoading, isError } = useQuery('transactions', () => useFetch('/api/transactions'))
    ...
    <>
      ...
      <Tabs.Root defaultValue="expenses" className="flow">
        ...
        <Tabs.Content className="TabsContent" value="expenses">
          {isLoading && <Loading />}
          {isError && <p>There was an error while loading expenses</p>}
        ...
        <Tabs.Content className="TabsContent" value="income">
          {isLoading && <Loading />}
          {isError && <p>There was an error while loading income</p>}
